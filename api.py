...
try:
    ...
    TypeLibPath = "{1EFD8E85-7F3B-48E6-9341-3C8B2F60136B}"
    win32com.client.gencache.GetModuleForTypelib(TypeLibPath,0x0,1,1)
    import win32com.gen_py.AutoCAD as ACAD
except Exception:
...
class Autocad(object):
    ...
    def app(self):
        ...
        win32com.client.gencache.MakeModuleForTypelib('{1EFD8E85-7F3B-48E6-9341-3C8B2F60136B}',0x0,1,1)
        global ACAD
        ACAD = win32com.client.gencache.GetModuleForTypelib('{1EFD8E85-7F3B-48E6-9341-3C8B2F60136B}',0x0,1,1)
        #print(repr(ACAD))
        return self._app
...
class AcadInstance(Autocad):
    def  __new__(cls):
        if not hasattr(cls, '_instance'):
            cls._instance = Autocad.__new__(cls)
        return cls._instance
    
def initACAD(): 
    return AcadInstance().ActiveDocument
##    print(repr(ThisDrawing)+'1')
    
#print(repr(ThisDrawing)+'2')
#print(repr(ACAD))
